...
class ContentManagement {
  ...
  loadArticles() {
    ...
    this.articles = [
      { id: 1, title: 'Pruning Techniques', content: 'Learn to prune like a pro...' },
      { id: 2, title: 'Wiring Methods', content: 'Master the art of wiring...' }
    ];
  ...
  loadEvents() {
    // Mock implementation; replace with actual API call
    this.events = [
      { id: 1, name: 'Spring Bonsai Festival', date: '2025-09-10', description: 'Join us for a festival...' },
      { id: 2, name: 'Winter Workshop', date: '2025-12-15', description: 'Learn winter care...' }
    ];
