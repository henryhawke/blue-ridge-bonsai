      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            description: 'Our special relationship with The North Carolina Arboretum',
            requirement: 'BR-08'
          },
          {
            id: 'meetings',
...
const NavigationHelper = {
    ...
    const filterItems = (items) => {
      return items.filter(item => {
        ...
        if (item.permission) {
          ...
          if (item.permission === 'board' && !['admin', 'board'].includes(userRole)) {
            return false;
          }
        }
  ...
  getBreadcrumbs(currentPath) {
    ...
    const pageNavigation = findPageInNav(SiteStructure.navigation.primary, currentPath);
    if (pageNavigation) {
